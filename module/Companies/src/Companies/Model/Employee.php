...
class Employee
{
    ...
    /**
     * First name. Allows only one word.
     * @var string
    ...
    /**
     * Last name. Allows several words, like "van Persie".
     * @var string
     * @Annotation\Attributes({"type":"text"})
    ...
    /**
     * Returns all valid properties of Employee.
     * @return array
     */
    public static function propertyNames()
    {
        return array('id', 'cid', 'name','lastname','email','startdate');
    }
